    ...
    return (
        ...
        <section id="home" className='flex text-center justify-center items-center w-full mt-28 font-home max-w-[1536px] mx-auto'>
            ...
            >
                ...
                >
                    <h1 className='text-4xl sm:text-6xl font-bold'>Alan Rrodriguez</h1>
                    <h3 className='text-xl sm:text-2xl'>Developer</h3>
                    <div className='flex flex-wrap self-end my-2 w-full justify-center'>
                        <a rel="noreferrer" target="_blank" href='https://github.com/alanrodgz' className={`px-2 hover:scale-125 cursor-pointer transition-all`}>
                            <SiGithub color='white' size={30} />
                        </a>
                        <a rel="noreferrer" target="_blank" href='https://www.linkedin.com/in/alan-r/' className={`px-2 hover:scale-125 cursor-pointer transition-all`}>
